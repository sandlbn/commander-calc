...
Fonts, fills, colours & Read past. The number format and bold are taken;
nothing else is. \\
Borders & Not read, and not written. A workbook exported to Excel loses the
borders \ccprod{} drew, and a bordered workbook imported from Excel arrives
without them. \\
